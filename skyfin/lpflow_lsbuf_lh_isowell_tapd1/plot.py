...
plt.xlabel("Time (s)"); plt.ylabel("V (stacked)"); plt.title("LPFLOW_LSBUF_LH_ISOWELL_TAPD1")
plt.legend(loc="upper right"); plt.grid(True); plt.tight_layout()
plt.savefig("lpflow_lsbuf_lh_isowell_tapd1.png", dpi=110); print("wrote lpflow_lsbuf_lh_isowell_tapd1.png")
plt.show()
