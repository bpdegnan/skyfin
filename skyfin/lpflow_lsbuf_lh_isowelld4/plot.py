...
plt.xlabel("Time (s)"); plt.ylabel("V (stacked)"); plt.title("LPFLOW_LSBUF_LH_ISOWELLD4")
plt.legend(loc="upper right"); plt.grid(True); plt.tight_layout()
plt.savefig("lpflow_lsbuf_lh_isowelld4.png", dpi=110); print("wrote lpflow_lsbuf_lh_isowelld4.png")
plt.show()
