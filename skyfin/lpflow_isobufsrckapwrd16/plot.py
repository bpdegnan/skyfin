...
plt.xlabel("Time (s)"); plt.ylabel("V (stacked)"); plt.title("LPFLOW_ISOBUFSRCKAPWRD16")
plt.legend(loc="upper right"); plt.grid(True); plt.tight_layout()
plt.savefig("lpflow_isobufsrckapwrd16.png", dpi=110); print("wrote lpflow_isobufsrckapwrd16.png")
plt.show()
