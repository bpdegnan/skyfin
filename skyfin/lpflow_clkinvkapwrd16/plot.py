...
plt.xlabel("Time (s)"); plt.ylabel("V (stacked)"); plt.title("LPFLOW_CLKINVKAPWRD16")
plt.legend(loc="upper right"); plt.grid(True); plt.tight_layout()
plt.savefig("lpflow_clkinvkapwrd16.png", dpi=110); print("wrote lpflow_clkinvkapwrd16.png")
plt.show()
