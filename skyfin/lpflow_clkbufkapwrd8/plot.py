...
plt.xlabel("Time (s)"); plt.ylabel("V (stacked)"); plt.title("LPFLOW_CLKBUFKAPWRD8")
plt.legend(loc="upper right"); plt.grid(True); plt.tight_layout()
plt.savefig("lpflow_clkbufkapwrd8.png", dpi=110); print("wrote lpflow_clkbufkapwrd8.png")
plt.show()
