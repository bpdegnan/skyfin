...
plt.xlabel("Time (s)"); plt.ylabel("V (stacked)"); plt.title("LPFLOW_CLKBUFKAPWRD4")
plt.legend(loc="upper right"); plt.grid(True); plt.tight_layout()
plt.savefig("lpflow_clkbufkapwrd4.png", dpi=110); print("wrote lpflow_clkbufkapwrd4.png")
plt.show()
