...
labels = ['D', 'SCD', 'SCE', 'CLK_N', 'SET_B', 'RESET_B', 'Q', 'Q_N']
...
plt.xlabel("Time (s)"); plt.ylabel("V (stacked)"); plt.title("SDFBBND1")
plt.legend(loc="upper right"); plt.grid(True); plt.tight_layout()
plt.savefig("sdfbbnd1.png", dpi=110); print("wrote sdfbbnd1.png")
plt.show()
