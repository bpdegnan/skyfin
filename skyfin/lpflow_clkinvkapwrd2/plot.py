...
plt.xlabel("Time (s)"); plt.ylabel("V (stacked)"); plt.title("LPFLOW_CLKINVKAPWRD2")
plt.legend(loc="upper right"); plt.grid(True); plt.tight_layout()
plt.savefig("lpflow_clkinvkapwrd2.png", dpi=110); print("wrote lpflow_clkinvkapwrd2.png")
plt.show()
