...
labels = ['D', 'SCD', 'SCE', 'CLK', 'SET_B', 'RESET_B', 'Q', 'Q_N']
...
plt.xlabel("Time (s)"); plt.ylabel("V (stacked)"); plt.title("SDFBBPD1")
plt.legend(loc="upper right"); plt.grid(True); plt.tight_layout()
plt.savefig("sdfbbpd1.png", dpi=110); print("wrote sdfbbpd1.png")
plt.show()
